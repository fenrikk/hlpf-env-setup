...
export class ProductsController {
  ...
  @Get()
  @ApiOperation({ summary: 'Отримати всі продукти', description: 'Публічний ендпоінт. Повертає список продуктів з категоріями.' })
  ...
  @Post()
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Створити продукт (тільки admin)' })
  ...
  @Patch(':id')
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Оновити продукт (тільки admin)' })
  ...
  @Delete(':id')
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Видалити продукт (тільки admin)' })
